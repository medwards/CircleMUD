...
size_t ffi_write_to_descriptor(struct DescriptorManager* manager, struct DescriptorId* identifier, const char* content);
size_t ffi_read_from_descriptor(struct DescriptorManager* manager, struct DescriptorId* identifier, char* read_point, size_t space_left);
